...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextAlarm(View view) {
        ...
        String toastMessage;
        if(nextAlarm !=null){
            Date dateInfo = new Date(nextAlarm.getTriggerTime());
            String newDate = DateFormat.getTimeInstance().format(dateInfo);

            toastMessage = "The next alarm is set for " + newDate + ".";
        }
        else {
            toastMessage = "There is no alarm scheduled";
        }
